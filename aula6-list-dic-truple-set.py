...
# Na tupla dá pra pegar o valor dos objetos ou editalos, mas não adicionar 
# e remover, ela não muda de tamanho.
# Quando utilizar? Quando o numero de objetos na lista não form mutável

pessoa_dict = {'nome': 'Marcus', 'idade': 25} # dicionário // key-value (chave-valor) 
ling_end_framework_dict = dict(java='spring', javascript='node') # outra forma de declarar um dicionário
...
print (pessoa_dict)
print (pessoa_dict['nome']) # uso da chave para buscar o valor // a chave é única
...
print(linguagens_set) # Não vai funcionar porque conjuntos não possuem itens iguais!
