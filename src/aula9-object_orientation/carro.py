...
class Carro(Veiculo):  # Herança, extends..
    ...
    def __init__(self, cor, marca, dono):
        # super referencia a classe pai no caso Veiculo # tô passando pro construtor da class pai.
        super().__init__(cor, marca, dono)
...
#     self.tanque = 0
    ...
    def toString(self):  # As funções têm que ter o argumento self
      # bem semelhante ao this de java, o self
        print('O carro pertence a '+str(self.dono)+', a marca é ' +
